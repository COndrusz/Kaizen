...
namespace Kaizen {
	...
	/*
	* Events are currently blocking so each event must be dealt with immediately
	* In future it would be better to switch to a buffering system
	*/
